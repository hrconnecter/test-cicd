...
//         expenseApprover: expenseApprover?.value || null,
//       };
...
//   <p className="">{expenseApprover?.label || "-"}</p>
// </div> */}
...
//   <h1 className="text-gray-500 text-sm">Expense Approver</h1>
//   <p className="">
//     {typeof expenseApprover === 'string' 
//       ? expenseApprover 
//       : expenseApprover?.label || "-"}
//   </p>
// </div> */}
...
const Test4 = ({ prevStep }) => { 
  ...
  data.assignedAssets.map(asset => ({
    ...
    assignedDate: asset.assignedDate
      ...
      console.log(" Asset Update employee data:", userData);
      const response = axios.put(
        `${process.env.REACT_APP_API}/route/employee/realupdate/${organisationId}/${employeeId}`,
        userData,
        {
