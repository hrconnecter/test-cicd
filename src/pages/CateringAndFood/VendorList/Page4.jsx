...
const Page4 = ({ prevStep }) => {
  ...
  console.log("document page4", document);
  ...
  const handleSubmit = useMutation(
    async () => {
      ...
      const response = await axios.put(
        `${process.env.REACT_APP_API}/route/employee/Vendor/realupdate/${organisationId}/${employeeId}`,
        updatedData,
        {
          headers: {
            Authorization: authToken,
    ...
    },
    {
      onSuccess: (response) => {
        ...
        emptyState();
        navigate(
          `/organisation/${organisationId}/catering/offboarding/vendorlist`
        );
      },
      onError: (error) => {
        handleAlert(
      ...
      <div className="w-full mt-4">
        ...
        <div className="md:p-3 py-1 ">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div className="p-2 w-[30%] rounded-sm ">
              <h1 className="text-gray-500 text-sm w-full">Current Address</h1>
