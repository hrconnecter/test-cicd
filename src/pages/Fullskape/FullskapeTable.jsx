...
const FullskapeTableComponent = ({ setValue, watch, addedEmployee = [], zoneId, openStudentModal, setOpenStudentModal }) => {
  ...
  const memberCount = data?.organisation?.studentCount || 0;

  // const memberCount = data?.organisation?.packageInfo === "Fullskape Plan" 
  // ? data?.organisation?.memberCount || 0 
  // : data?.organisation?.studentCount || 0;

  console.log("studentcount", data);
  const isdisableadd = studentCount === memberCount;
  ...
  return (
    ...
    />
      ...
      <div className="flex gap-4 mb-6 items-center justify-between">
        ...
        className="ml-auto"
        disabled={isdisableadd} // Add this line
      >
        Add Students
      </Button>
    ...
    <div className="text-center text-gray-500 mt-8">
      <p>No students found. Adjust your filters or add new students to this zone.</p>
    </div>
  ) : (
