          ...
          >
            ...
            >
              ...
              <div className="mt-3">
                ...
                {/* <div className='flex'>
                                    <span className="mx-1">{jobDetails?.salary?.currency}</span>{" "}
                                    {jobDetails.salary?.startSalary
                                        ? `${jobDetails.salary?.startSalary} To ${jobDetails?.salary?.endSalary}`
                                        : null}
                                </div> */}
              </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="mt-2">
                          ...
                          {/* <div className='flex'>
                                                    <span className="mx-1">{vacancy?.salary?.currency}</span>{" "}
                                                    {vacancy.salary?.startSalary
                                                        ? `${vacancy.salary?.startSalary} To ${vacancy.salary?.endSalary}`
                                                        : null}
                                                </div> */}
                        </div>
                      </div>
