              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      width: "100%", // Ensures the div spans the full width of the parent container
                      textAlign: "center", // Optional for additional alignment adjustments
                    }}
                  >
                    {/* <BasicButton
                                        title="View Details"
                                    ...
                                    /> */}
                    <Link
                      to={`/organisation/${organisationId}/view-job-detail-application/${jobId}/${application?._id}`}
                      className="font-semibold text-blue-500 hover:underline text-md mt-2"
                    >
                      View Details
                    </Link>
                  </div>
