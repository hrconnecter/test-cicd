  ...
  const handleSubmit = useMutation(
    (overrideData = {}) => {
      ...
      if (role === "Manager" && vacancyId) {
        ...
        apiEndpoint = `${process.env.REACT_APP_API}/route/organization/${organisationId}/hr/${hrId}/vacancy/${vacancyId}/hiring`;
      } else {
        apiEndpoint = `${process.env.REACT_APP_API}/route/organization/${organisationId}/hr/${hrId}/hr-create-job-position/hiring`;
      }
    ...
    },
    {
      onSuccess: () => {
        ...
        handleAlert(true, "success", "Job vacancy added successfully!");
        if (role === "Manager") {
