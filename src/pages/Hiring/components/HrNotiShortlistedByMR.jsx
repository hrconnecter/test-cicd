  ...
  return (
    <div>
      <div className="space-y-6 px-4">
        {shortlistedApplicationByMR?.shortlistedApplicationByMR?.map(
          (vacancy, idx) => (
            <div
              key={idx}
              className="flex justify-between items-center  bg-white border border-gray-300 rounded-md shadow-md p-6 py-2 space-y-4"
            >
              ...
              <div className="flex gap-2">
                <BasicButton
                  ...
                  onClick={() =>
                    handleAction(vacancy?.jobId?._id, vacancy?._id)
                  }
                />
                <BasicButton
