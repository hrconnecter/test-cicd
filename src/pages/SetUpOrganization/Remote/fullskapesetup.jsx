...
import MiniFormFullskape from "./components/miniformfullskape";

const FullskapeSetup = () => {
  //get organisationId
        ...
        <div className="h-[90vh] overflow-y-auto scroll px-3">
          <div className="xs:block sm:block md:flex justify-between items-center ">
            <HeadingOneLineInfo
              className="!my-3"
              heading="Fullskape"
              info="Configure Fullskape settings"
            /></div>
          {isLoading ? (
            ...
            data && <MiniFormFullskape data={data} mutate={mutate} />
          )}
        </div>
      </Setup>
    </BoxComponent>
