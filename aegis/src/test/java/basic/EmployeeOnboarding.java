...
public class EmployeeOnboarding {
    ...
    private void fillFirstPageDetails() throws InterruptedException {
        ...
        driver.findElement(By.name("email")).sendKeys("manager@burberry.com");
    ...
    private void fillSecondPageDetails() throws InterruptedException {
        ...
        driver.findElement(By.name("empId")).sendKeys("B-008");
        driver.findElement(By.name("companyemail")).sendKeys("burberry@gmail.com");
        ...
        selectDropdown("(//input[@role='combobox'])[5]", "employee");
        selectDropdown("(//input[@role='combobox'])[7]", "001");
        selectDropdown("(//input[@role='combobox'])[8]", "dubai");
